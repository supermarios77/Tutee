window.__GOOGLE_TRANSLATION_CONFIG__ = {
  languages: [
    ...
    { title: 'Turkçe', name: 'tr' },
    { title: '中文', name: 'zh-CN' }, // Chinese (Simplified)
    ...
    { title: 'ภาษาไทย', name: 'th' }, // Thai
    { title: 'Dansk', name: 'da' }, // Danish
    { title: 'Svenska', name: 'sv' }, // Swedish
    { title: 'Norsk', name: 'no' }, // Norwegian
    { title: 'Suomi', name: 'fi' }, // Finnish
  ],
  defaultLanguage: 'en',
};
