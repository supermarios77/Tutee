...
function SidebarContent({
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  />
                  {(isExpanded || isMobile) && (
                    <p className="text-lg font-semibold ml-4">{item.label}</p>
                  )}
                </Link>
              </TooltipTrigger>
              <TooltipContent
  ...
  return <div className="flex flex-1 flex-col gap-6">{memoizedLinks}</div>;
}
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <section
        className={cn(
          'sticky left-0 top-0 flex h-screen flex-col justify-between p-6 pt-28 max-sm:hidden',
