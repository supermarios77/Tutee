    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-blue-900 to-blue-800 dark:from-blue-950 dark:to-black min-h-screen flex items-center">
      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        ...
        >
          ...
          >
            Transform your language skills with personalized lessons from
            certified professionals. Sign up now and get your first lesson free!
          </motion.p>
          <motion.div
            variants={itemVariants}
          ...
          >
            <Button
              asChild
              size="lg"
              className="text-xl px-10 py-6 bg-white text-blue-900 hover:bg-blue-100 transition-colors duration-300"
            >
              <Link href="/sign-up">
          ...
          {[
            {
              ...
              title: 'Expert Tutors',
              description:
                'Learn from certified English language professionals',
            },
            {
              icon: GraduationCapIcon,
              title: 'Personalized Learning',
              description: 'Tailored lessons to meet your specific goals',
            },
            {
              icon: GlobeIcon,
